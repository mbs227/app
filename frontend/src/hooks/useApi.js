...
export const useUser = () => {
  const { data: user, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ userAPI }) => userAPI.getCurrentUser())
  );
...
export const useGoals = () => {
  const { data: goals, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ goalsAPI }) => goalsAPI.getGoals())
  );
...
export const useHabits = () => {
  const { data: habits, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ habitsAPI }) => habitsAPI.getHabits())
  );
...
export const useJournalEntries = () => {
  const { data: entries, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ journalAPI }) => journalAPI.getJournalEntries())
  );
...
export const useAffirmations = () => {
  const { data: affirmations, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ affirmationsAPI }) => affirmationsAPI.getAffirmations())
  );
...
export const useGratitudeEntries = () => {
  const { data: entries, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ gratitudeAPI }) => gratitudeAPI.getGratitudeEntries())
  );
...
export const useCommunityPosts = () => {
  const { data: posts, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ communityAPI }) => communityAPI.getCommunityPosts())
  );
...
export const useVisionBoards = () => {
  const { data: boards, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ visionBoardAPI }) => visionBoardAPI.getVisionBoards())
  );
...
export const useTemplates = () => {
  const { data: templates, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ templatesAPI }) => templatesAPI.getTemplates())
  );
...
export const useGlobalStats = () => {
  const { data: stats, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ statsAPI }) => statsAPI.getGlobalStats())
  );
...
export const useUserStats = () => {
  const { data: stats, loading, error, refetch } = useApi(() => 
    import('../api/apiService').then(({ statsAPI }) => statsAPI.getUserStats())
  );
